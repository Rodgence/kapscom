...
<div class="container mt-5 pt-5">
    <div class="row pt-5 mt-5">
        ...
        <div class="col-md-6">
            <p>
                KAPSCOM AFRICA designs intercom systems with/without video for the
                entrance security of homes and offices and offers a wide range of products
                in this field from small home systems to large systems for residential
                estates such as condominiums according to the operating scenario
                provided by the customer and the risk analysis carried out by our engineers
        ...
        <div class="col-md-6">
            <img src="assets/img/videointercom.webp" alt="" width="100%">
        </div>
    </div>
